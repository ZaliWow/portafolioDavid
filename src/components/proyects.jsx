    ...
    const [listOfProyect, setListOfProyect] = useState([
        {
            ...
            description:"Project Description: Backend Development for User Management System This project focuses on creating an efficient backend using Node.js, Express.js and PostgreSQL for a user management system. The combination of these technologies provides a scalable and high-performance architecture. The backend offers a RESTful API to perform basic operations such as fetching the list of users and creating new users with information such as name and email. Special attention is paid to error and exception handling, ensuring clear responses in problematic situations. The architecture is designed to be scalable, allowing future expansions and improvements according to the needs of the system. The primary goal is to provide a robust infrastructure that meets user management requirements efficiently and securely. This backend, by adopting modern technologies and following best practices, seeks to be the robust foundation for future applications. Key Technologies: Node.js, Express.js, PostgreSQL, RESTful API, Scalability, Security",
        ...
        },
{
    ...
    presentation:"images/nodeJS.svg",
    avatar:"data:image/png;base64,",
    description:"Project made with ExpressJS in a NodeJS and JavaScript environment to allow users to upload songs and like other users' songs, allowing them to have their own playlists. Technologies: PostgreSQL, FireBase Storage, NodeJS, ExpressJS",
...
},
{
    ...
    description:"100% responsive web project that allows student users to review mathematics and teacher users to completely control the students' environment",
 ...
 {tittle:"Frontend Univalletify",
    ...
    presentation:"images/react.svg",
    urlproyect:"",
    description:"Web project where users can upload songs and see songs that other users previously uploaded, giving the possibility of adding them to a playlist of songs that you like.",
    herramientas:"ReactJS + ViteJS, React + Bootstrap",
    viewproyect:"",
    tools:["NodeJs","React"," Material UI"," Bootstrap", "Canva", "LeonardAI"]
},{
    ...
    description:"Web application, mobile design to provide users with a restaurant menu and send messages via WhatsApp from the website",
...
},
 {
    ...
    description:"Mobile application design, application to watch and share movies." ,
    herramientas:"Figma, Canva",
