...
import "../styles/whatsapp.css"
 ...
 export function WhatsAppButton({mode}) {
  ...
  if (mode===true)return (
    ...
    <IconButton onClick={handleSendMessage}><WhatsApp sx={{color:'black', }}></WhatsApp></IconButton>
  ...
  if (mode===false)return(
    <div className="bodyWhatsapp">
    <IconButton onClick={handleSendMessage}><WhatsApp sx={{color:'white',}}></WhatsApp></IconButton>
